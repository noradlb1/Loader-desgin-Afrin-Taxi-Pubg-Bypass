...
struct ImDrawList
{
    ...
    IMGUI_API void  sliderline(const ImVec2& p1, const ImVec2& p2, ImU32 col, float thickness);
    ...
    IMGUI_API void addtriagnle(const ImVec2& pos, ImU32 color, ImGuiDir dir);
    ...
    inline    void  PathStroke2(ImU32 col, bool closed, float thickness = 2.0f) { AddPolyline(_Path.Data, _Path.Size, col, closed, thickness); _Path.Size = 0; }
