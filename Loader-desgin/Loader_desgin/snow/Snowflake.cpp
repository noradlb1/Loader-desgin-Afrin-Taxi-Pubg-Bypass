...
//////#include <cmath>
//////#include <vector>
//////#include <cstdlib> // لمولد الأرقام العشوائية
//////
//////namespace Snowflake {
//////
//////    vec3 gravity;
...
//////        : minSize(_minSize), maxSize(_maxSize), windowX(_windowX), windowY(_windowY), width(_width), height(_height), color(_color) {
...
//////        ImGui::GetForegroundDrawList()->AddCircleFilled(ImVec2(pos.x, pos.y), radius, color);
//////    }
//////
...
//////    }
//////
//////    void Update(std::vector<Snowflake>& snow, vec3 mouse, vec3 windowPos) {
//////        mouse.x -= windowPos.x;
//////        mouse.y -= windowPos.y;
//////
